...
export class ApiService {
    ...
    async getCodeforcesSvg(handle){
        ...
        return `<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="181" height="20" role="img"
        ...
        <g clip-path="url(#r)">
            ...
            <rect x="140" width="41" height="20" fill="#555" />
            <rect width="181" height="20" fill="url(#s)" />
        </g>
        <g fill="#fff" text-anchor="middle" font-family="Verdana,Geneva,DejaVu Sans,sans-serif"
            ...
            <text aria-hidden="true" x="355" y="150" fill="#010101" fill-opacity=".3" transform="scale(.1)" textLength="590">codeforces</text>
                ...
                <text aria-hidden="true" x="1035" y="150" fill="#010101" fill-opacity=".3" transform="scale(.1)" textLength="610">${handle}</text>
                <text x="1035" y="140" transform="scale(.1)" fill="#fff" textLength="610">${handle}</text>
                <text aria-hidden="true" x="1600" y="150" fill="#010101" fill-opacity=".3" transform="scale(.1)" textLength="310">${rating}</text>
                <text x="1600" y="140" transform="scale(.1)" fill="#fff" textLength="310">${rating}</text>
        </g>
    </svg>`;
    }
}
